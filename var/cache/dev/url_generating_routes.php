...
return [
    ...
    'tacheSemaineAddEdit' => [['idStage', 'numSemaine'], ['idStage' => '0', 'numSemaine' => '0', '_controller' => 'App\\Controller\\SemaineStageController::addEditTache'], ['idStage' => '\\d+', 'numSemaine' => '\\d+'], [['variable', '/', '\\d+', 'numSemaine', true], ['variable', '/', '\\d+', 'idStage', true], ['text', '/etudiant/stage/addTache']], [], []],
    'tacheSemaineAdd' => [['idStage', 'numSemaine'], ['idStage' => '0', 'numSemaine' => '0', '_controller' => 'App\\Controller\\TacheSemaineController::add'], ['idStage' => '\\d+', 'numSemaine' => '\\d+'], [['variable', '/', '\\d+', 'numSemaine', true], ['variable', '/', '\\d+', 'idStage', true], ['text', '/etudiant/stage/tache/add']], [], []],
