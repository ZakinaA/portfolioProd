...
return [
    ...
    'etudiantRpsArchivees' => [[], ['_controller' => 'App\\Controller\\EtudiantController::getLesRPArchivees'], [], [['text', '/etudiant/rpsArchivees']], [], [], []],
    ...
    'stageAddEdit' => [['idStage'], ['idStage' => '0', '_controller' => 'App\\Controller\\StageController::addEdit'], ['idStage' => '\\d+'], [['variable', '/', '\\d+', 'idStage', true], ['text', '/etudiant/stage/addEdit']], [], [], []],
    ...
    'rpsEtudiantsParSpecialiteEtNiveau' => [['idSpecialite', 'idNiveau', 'source'], ['_controller' => 'App\\Controller\\EnseignantController::listRpsEtudiantsParSpecialiteEtNiveau'], [], [['variable', '/', '[^/]++', 'source', true], ['variable', '/', '[^/]++', 'idNiveau', true], ['variable', '/', '[^/]++', 'idSpecialite', true], ['text', '/enseignant/promo/etudiants/list']], [], [], []],
    'commentaireRpAdd' => [['idRp'], ['_controller' => 'App\\Controller\\RpCommentaireController::addCommentaire'], [], [['variable', '/', '[^/]++', 'idRp', true], ['text', '/enseignant/rp/commentaire/add']], [], [], []],
    'rpsParEtudiant' => [['idEtudiant'], ['_controller' => 'App\\Controller\\RpController::listParEtudiant'], [], [['variable', '/', '[^/]++', 'idEtudiant', true], ['text', '/enseignant/etudiant/rp/list']], [], [], []],
    'rpValider' => [['idRp'], ['idRp' => '0', '_controller' => 'App\\Controller\\RpController::valider'], ['idRp' => '\\d+'], [['variable', '/', '\\d+', 'idRp', true], ['text', '/enseignant/rp/valider']], [], [], []],
    'enseignantShowEdit' => [[], ['_controller' => 'App\\Controller\\EnseignantController::showEdit'], [], [['text', '/enseignant/showEdit']], [], [], []],
