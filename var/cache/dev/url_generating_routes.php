...
return [
    ...
    'listRpsEtudiantsParSpecialiteEtNiveau' => [['idSpecialite', 'idNiveau', 'source'], ['_controller' => 'App\\Controller\\EnseignantController::listRpsEtudiantsParSpecialiteEtNiveau'], [], [['variable', '/', '[^/]++', 'source', true], ['variable', '/', '[^/]++', 'idNiveau', true], ['variable', '/', '[^/]++', 'idSpecialite', true], ['text', '/enseignant/promo/etudiants/list']], [], []],
    ...
    'listStagesByEtudiant' => [['idEtudiant'], ['_controller' => 'App\\Controller\\StageController::listStagesByEtudiant'], [], [['variable', '/', '[^/]++', 'idEtudiant', true], ['text', '/enseignant/stage/listStagesByEtudiant']], [], []],
