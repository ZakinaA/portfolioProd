...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            ...
            'App\\Form\\CommentaireEnseignantType' => ['privates', 'App\\Form\\CommentaireEnseignantType', 'getCommentaireEnseignantTypeService', true],
            ...
            'App\\Form\\NotifierEnseignantType' => ['privates', 'App\\Form\\NotifierEnseignantType', 'getNotifierEnseignantTypeService', true],
            'App\\Form\\ProductionType' => ['privates', 'App\\Form\\ProductionType', 'getProductionTypeService', true],
            'App\\Form\\RPType' => ['privates', 'App\\Form\\RPType', 'getRPTypeService', true],
            ...
            'App\\Form\\RpActiviteType' => ['privates', 'App\\Form\\RpActiviteType', 'getRpActiviteTypeService', true],
            'App\\Form\\SemaineStageType' => ['privates', 'App\\Form\\SemaineStageType', 'getSemaineStageTypeService', true],
            'App\\Form\\StageType' => ['privates', 'App\\Form\\StageType', 'getStageTypeService', true],
            'App\\Form\\TacheSemaineType' => ['privates', 'App\\Form\\TacheSemaineType', 'getTacheSemaineTypeService', true],
            'App\\Form\\UserEnseignantType' => ['privates', 'App\\Form\\UserEnseignantType', 'getUserEnseignantTypeService', true],
            'App\\Form\\UserEtudiantType' => ['privates', 'App\\Form\\UserEtudiantType', 'getUserEtudiantTypeService', true],
            ...
            'App\\Form\\CommentaireEnseignantType' => '?',
            'App\\Form\\CommentaireType' => '?',
            'App\\Form\\EnseignantType' => '?',
            'App\\Form\\EtudiantType' => '?',
            'App\\Form\\FileUploadType' => '?',
            'App\\Form\\NotifierEnseignantType' => '?',
            'App\\Form\\ProductionType' => '?',
            'App\\Form\\RPType' => '?',
            'App\\Form\\RegistrationType' => '?',
            'App\\Form\\ResetPasswordRequestFormType' => '?',
            'App\\Form\\RpActiviteType' => '?',
            'App\\Form\\SemaineStageType' => '?',
            'App\\Form\\StageType' => '?',
            'App\\Form\\TacheSemaineType' => '?',
            'App\\Form\\UserEnseignantType' => '?',
            'App\\Form\\UserEtudiantType' => '?',
