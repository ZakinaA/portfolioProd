 ...
 */
class getNiveauRPRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NiveauRPRepository' shared autowired service.
     *
     * @return \App\Repository\NiveauRPRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NiveauRPRepository.php';

        return $container->privates['App\\Repository\\NiveauRPRepository'] = new \App\Repository\NiveauRPRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
