 ...
 */
class getSourceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SourceRepository' shared autowired service.
     *
     * @return \App\Repository\SourceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SourceRepository.php';

        return $container->privates['App\\Repository\\SourceRepository'] = new \App\Repository\SourceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
