 ...
 */
class getDomaineTacheRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DomaineTacheRepository' shared autowired service.
     *
     * @return \App\Repository\DomaineTacheRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DomaineTacheRepository.php';

        return $container->privates['App\\Repository\\DomaineTacheRepository'] = new \App\Repository\DomaineTacheRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
