 ...
 */
class getTacheSemaineRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TacheSemaineRepository' shared autowired service.
     *
     * @return \App\Repository\TacheSemaineRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TacheSemaineRepository.php';

        return $container->privates['App\\Repository\\TacheSemaineRepository'] = new \App\Repository\TacheSemaineRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
