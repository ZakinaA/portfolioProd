 ...
 */
class getCadreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CadreRepository' shared autowired service.
     *
     * @return \App\Repository\CadreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CadreRepository.php';

        return $container->privates['App\\Repository\\CadreRepository'] = new \App\Repository\CadreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
