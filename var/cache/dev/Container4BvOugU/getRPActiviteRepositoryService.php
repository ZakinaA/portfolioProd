 ...
 */
class getRPActiviteRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RPActiviteRepository' shared autowired service.
     *
     * @return \App\Repository\RPActiviteRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RPActiviteRepository.php';

        return $container->privates['App\\Repository\\RPActiviteRepository'] = new \App\Repository\RPActiviteRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
