...
class __TwigTemplate_b8111d337f33a49e53df4dc70c395a6b6a3831683b18dbf6dbd397998d88d59d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("basePublic.html.twig", "reset_password/request.html.twig", 1);
    ...
    public function block_contenuPublic($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 4, $this->source); })()), "flashes", [0 => "reset_password_error"], "method", false, false, false, 4));
    ...
    ";
        ...
        // line 7
        echo "    <h3>Réinitialiser votre mot de passe</h3>
    ...
    ";
        ...
        ";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 10, $this->source); })()), "email", [], "any", false, false, false, 10), 'row');
        echo "
        <div>
            <small>
            Saisir votre email et un lien vous sera renvoyé par mail pour le réinitialiser
            </small>
        </div>
<div> </div>
    ...
    ";
        // line 18
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["requestForm"]) || array_key_exists("requestForm", $context) ? $context["requestForm"] : (function () { throw new RuntimeError('Variable "requestForm" does not exist.', 18, $this->source); })()), 'form_end');
        echo "
";
    ...
    {
        return array (  101 => 18,  90 => 10,  86 => 9,  82 => 7,  73 => 5,  68 => 4,  58 => 3,  35 => 1,);
    }
